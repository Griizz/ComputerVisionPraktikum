...
model.add(Conv2D(32, (3, 3), activation='relu', padding='same', name='conv1.3', input_shape=(256, 256, 3)))
model.add(Conv2D(32, (3, 3), activation='relu', padding='same', name='conv1.4', input_shape=(256, 256, 3)))
...
model.add(Conv2D(64, (3, 3), activation='relu', padding='same', name='conv2.3'))
model.add(Conv2D(64, (3, 3), activation='relu', padding='same', name='conv2.4'))
model.add(MaxPooling2D(pool_size=(2, 2)))
...
model.add(Conv2D(128, (3, 3), activation='relu', padding='same', name='conv3.3'))
model.add(Conv2D(128, (3, 3), activation='relu', padding='same', name='conv3.4'))
model.add(MaxPooling2D(pool_size=(2, 2)))
model.add(Flatten())
